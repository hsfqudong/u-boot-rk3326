...
#endif
#ifdef CONFIG_OPTEE_CLIENT
    char *device_id_file = "androidboot.deviceid";
    unsigned char value[32] = "";
    char msg[100] = {0};
    read_from_keymaster((uint8_t *)device_id_file, strlen(device_id_file), value, sizeof(value));
    printf("hzf Device ID:[%s]\n", value);
    snprintf(msg, 54, "androidboot.deviceid=%s", value);
        env_update("bootargs", msg);
#endif
